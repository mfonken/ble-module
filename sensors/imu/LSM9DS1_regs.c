...
void LSM9DS1_defaultInit( LSM9DS1_cfg_t * this )
{
    ...
    this->g.ctrl1                    	= *( LSM9DS1_ctrl_reg1_g_t     *)&ctrl_reg1_g_default;
    this->g.ctrl2                    	= *( LSM9DS1_ctrl_reg2_g_t     *)&ctrl_reg2_g_default;
    this->g.ctrl3                    	= *( LSM9DS1_ctrl_reg3_g_t     *)&ctrl_reg3_g_default;
    this->g.interrupt_threshold_x    	= *( LSM9DS1_int_gen_ths_x_g_t *)&int_gen_ths_x_g_default;
    this->g.interrupt_threshold_y    	= *( LSM9DS1_int_gen_ths_y_g_t *)&int_gen_ths_y_g_default;
    this->g.interrupt_threshold_z    	= *( LSM9DS1_int_gen_ths_z_g_t *)&int_gen_ths_z_g_default;
    this->g.orientation              	= *( LSM9DS1_orient_cfg_g_t    *)&orient_cfg_g_default;
    this->g.interrupt_configuration  	= *( LSM9DS1_int_gen_cfg_g_t   *)&int_gen_cfg_g_default;
    this->g.interrupt_duration       	= *( LSM9DS1_int_gen_dur_g_t   *)&int_gen_dur_g_default;
    this->g.enable                   	= *( LSM9DS1_ctrl_reg4_t       *)&ctrl_reg4_default;
    ...
    this->m.x_offset                  	= *( LSM9DS1_offset_x_reg_m_t *)&offset_x_reg_m_default;
    this->m.y_offset                  	= *( LSM9DS1_offset_y_reg_m_t *)&offset_y_reg_m_default;
    this->m.z_offset                  	= *( LSM9DS1_offset_z_reg_m_t *)&offset_z_reg_m_default;
    this->m.odr_control               	= *( LSM9DS1_ctrl_reg1_m_t    *)&ctrl_reg1_m_default;
    this->m.fs_control                	= *( LSM9DS1_ctrl_reg2_m_t    *)&ctrl_reg2_m_default;
    this->m.configuration_control     	= *( LSM9DS1_ctrl_reg3_m_t    *)&ctrl_reg3_m_default;
    this->m.operative_mode            	= *( LSM9DS1_ctrl_reg4_m_t    *)&ctrl_reg4_m_default;
    this->m.block_data_update_control 	= *( LSM9DS1_ctrl_reg5_m_t    *)&ctrl_reg5_m_default;
    this->m.interrupt_configuration   	= *( LSM9DS1_int_cfg_m_t      *)&int_cfg_m_default;
    this->m.interrupt_threshold       	= *( LSM9DS1_int_ths_t        *)&int_ths_m_default;
